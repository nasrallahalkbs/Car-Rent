...
urlpatterns = [
    ...
    path('admin/dashboard/reservations/<int:reservation_id>/<str:status>/', admin_views.update_reservation_status, name='update_reservation_status'),
    ...
    path('admin/dashboard/payments/<str:payment_id>/receipt/', admin_views.print_receipt, name='print_receipt'),
    path('admin/dashboard/payments/<str:payment_id>/refund/', admin_views.process_refund, name='process_refund'),
    path('admin/dashboard/payments/<str:payment_id>/mark-paid/', admin_views.mark_as_paid, name='mark_as_paid'),
    ...
    path('admin/dashboard/payments/add-manual/', admin_views.add_manual_payment, name='add_manual_payment'),
