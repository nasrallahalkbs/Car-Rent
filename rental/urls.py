...
urlpatterns = [
    ...
    path('dashboard/reports/print-settings/<str:report_type>/', admin_views.report_print_settings, name='report_print_settings'),
    path('ar/dashboard/reports/print-settings/<str:report_type>/', admin_views.report_print_settings, name='report_print_settings_ar'),
    ...
    # تم حذف المسار المكرر للملف الشخصي للمشرف
