...
"""
النسخة النهائية لإنشاء تقرير فحص سيارة باستخدام البنية الدقيقة للعناصر في النظام

هذا السكريبت يقوم بإنشاء تقرير فحص سيارة كامل يتطابق تماماً مع النموذج الموجود في النظام الفعلي.
يستخدم فقط العناصر المهمة والمكلفة والحرجة المصفاة وفقاً لتصميم الواجهة الفعلية.
"""
...
def create_final_car_inspection_report():
    """
    النسخة النهائية لإنشاء تقرير فحص سيارة مطابق تماماً للنموذج الموجود في النظام
    """
    ...
    for item in inspection_items:
        ...
        try:
            detail = CarInspectionDetail.objects.create(
                report=report,
                inspection_item=item,  # استخدام الاسم الصحيح للحقل: inspection_item
                condition=condition,
...
if __name__ == "__main__":
    ...
    report_id = create_final_car_inspection_report()
