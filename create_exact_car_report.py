...
يستخدم فقط العناصر المهمة والمكلفة والحرجة كما يتم تصفيتها في واجهة النظام.
"""
...
def create_exact_car_inspection_report():
    ...
    try:
        report = CarConditionReport.objects.create(
            ...
            customer_name=reservation.customer_name or "العميل",
            employee_name=admin_user.get_full_name() or admin_user.username
        )
